...
def run():
    ...
    img = Image.open("C:/Users/khush/OneDrive/Pictures/Resume Analyzer.jpg")
    st.image(img)
    st.sidebar.markdown("# Choose Something...")
    activities = ["User", "Feedback", "About", "Admin"]
    choice = st.sidebar.selectbox("Choose among the given options:", activities)
    link = '<b>Built with 🤍 by <a href="https://www.linkedin.com/in/khushbukumari3004/" style="text-decoration: none; color: #021659;">Khushbu</a></b>' 
